    ...
    <section className="relative min-h-[70vh] md:min-h-screen flex flex-col justify-center px-6 pt-24 md:pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center relative z-10">
        <div className="order-2 md:order-1 text-left">
          <div className="inline-block px-4 py-1.5 mb-6 md:mb-8 rounded-full border border-white/10 glass text-amber-500 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase">
            {t.badge}
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold leading-[1.05] mb-6 md:mb-8 gradient-text">
            {t.title}
          </h1>
          
          <p className="text-lg md:text-xl lg:text-2xl text-white/60 font-light mb-8 md:mb-12 max-w-xl leading-relaxed">
            {t.subtitle}
          </p>
        ...
        <div className="order-1 md:order-2 flex justify-center md:justify-end">
          <div className="relative group w-full max-w-[320px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-[500px]">
            ...
            {/* Floating Info Tag */}
            <div className="absolute -bottom-4 md:-bottom-6 -left-4 md:-left-6 glass px-4 py-3 md:px-6 md:py-4 rounded-xl md:rounded-2xl border-white/10 shadow-xl hidden sm:block">
